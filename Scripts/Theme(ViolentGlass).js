...
(function() {
    ...
    function fetchAndApplyJS() {
        // Here, you can delete lines with links to functions you don't want.
        addScriptFromURL('https://TheGirlThatLived.github.io/NarrowOne_Customizations/Scripts/ImageSubstitution.js'); // Custom images
        addScriptFromURL('https://TheGirlThatLived.github.io/NarrowOne_Customizations/Scripts/NotificationIconReplacer.js'); // Custom icon indicators
