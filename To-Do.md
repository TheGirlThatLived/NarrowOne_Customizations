...
- Violent Glass
    ...
    - [x] Glassify the Main Menu buttons and hidden sub-menus (personal stats; squad window), set zoom to  100% and override UI menus scaling.
    ...
    - [x] Glassify the HP bar
    - [x] HP Bar: Tape it together better, so the elements don't slide away for different screen resolutions
